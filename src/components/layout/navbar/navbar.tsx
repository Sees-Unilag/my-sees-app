  ...
  return (
    ...
    >
      <div className={`${styles.navContainer} h-100 w-100`}>
        {/* Logo Div */}
        <div
          className={`${styles.navLogoDiv} d-none d-md-flex align-items-center justify-content-center`}
        >
          <img className={`${styles.navLogoImg}`} src={Logo} alt="logo" />
        </div>
        {/* NavMenuLists */}
        <ul
          className={`text-white d-flex align-items-center justify-content-between flex-md-column ${styles.navUl}`}
        >
          {navlinks}
        </ul> 
      </div>
